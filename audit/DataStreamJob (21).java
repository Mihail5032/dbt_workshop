...
public class DataStreamJob {
    public static final String CATALOG = "raw";
    public static final String SCHEMA = "flink_test";
    ...
    public void run() throws Exception {
        ...
        TableIdentifier tableIdentifier = TableIdentifier.of(SCHEMA, "raw_table_test"); //wpuwbw_const
