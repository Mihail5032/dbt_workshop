...
public class DataStreamJob {
    ...
    public void run() throws Exception {
        ...
        pstTableMap.put("PST_BPTRANSACTION",              TableIdentifier.of(SCHEMA, "raw_bptransaction_2"));
        pstTableMap.put("PST_BPFINANCIALMOVEMEN",          TableIdentifier.of(SCHEMA, "raw_bpfinancialmovemen_2"));
        pstTableMap.put("PST_BPTRANSACTEXTENSIO",          TableIdentifier.of(SCHEMA, "raw_bptransactextensio_2"));
        pstTableMap.put("PST_BPFINANCIALMOVEMENTEXTENSIO", TableIdentifier.of(SCHEMA, "raw_bpfinacialmovement_2"));
        pstTableMap.put("PST_BPRETAILLINEITEM",            TableIdentifier.of(SCHEMA, "raw_bpretaillineitem_2"));
        pstTableMap.put("PST_BPLINEITEMEXTENSIO",          TableIdentifier.of(SCHEMA, "raw_bplineitemextensio_2"));
        pstTableMap.put("PST_BPLINEITEMDISCOUNT",          TableIdentifier.of(SCHEMA, "raw_bplineitemdiscount_2"));
        pstTableMap.put("PST_BPLINEITEMDISCEXT",           TableIdentifier.of(SCHEMA, "raw_bplineitemdiscext_2"));
        pstTableMap.put("PST_BPTRANSACTDISCEXT",           TableIdentifier.of(SCHEMA, "raw_bptransactdiscext_2"));
        pstTableMap.put("PST_BPTENDER",                    TableIdentifier.of(SCHEMA, "raw_bptender_2"));
        pstTableMap.put("PST_BPTENDEREXTENSIONS",          TableIdentifier.of(SCHEMA, "raw_bptenderextensions_2"));
        ...
        // ===== TEST MODE: пишем только raw_bptransaction в raw_transaction_test_2 =====
        // SourceDocument sink отключён.
        ...
        //         TableIdentifier.of(SCHEMA, "raw_bpsourcedocumentli_2"));
        ...
        // ============ TEST MODE: единственный sink — raw_bptransaction → raw_transaction_test_2 ============
        OutputTag<RowData> txnTag = StreamSideOutputTag.getTag("E1BPTRANSACTION");
        DataStream<RowData> txnStream = processed.getSideOutput(txnTag);
        TableLoader txnTestLoader = TableLoader.fromCatalog(catalogLoader,
                TableIdentifier.of(SCHEMA, "raw_transaction_test_2"));
        FlinkSink.forRowData(txnStream)
                .tableLoader(txnTestLoader)
                .writeParallelism(1)
                .upsert(false)
                .uidPrefix("sink-raw-transaction-test")
                .set("write.target-file-size-bytes", "268435456")
                .append();

        // ============ RAW sinks (4 сегмента без PST) — DISABLED FOR TEST ============
        // Map<String, TableIdentifier> rawOnlyTableMap = new HashMap<>();
        // rawOnlyTableMap.put("E1BPLINEITEMTAX",      TableIdentifier.of(SCHEMA, "raw_bplineitemtax_2"));
        // rawOnlyTableMap.put("E1BPRETAILTOTALS",     TableIdentifier.of(SCHEMA, "raw_bpretailtotals_2"));
        // rawOnlyTableMap.put("E1BPTENDERTOTALS",     TableIdentifier.of(SCHEMA, "raw_bptendertotals_2"));
        // rawOnlyTableMap.put("E1BPTRANSACTIONDISCO", TableIdentifier.of(SCHEMA, "raw_bptransactiondisco_2"));
        //
